...
class Node:
    ...
    def draw(self, win, ):
        ...
        # Width twice, everything is square
...
def algorithm(draw, grid, start, end):
    ...
    # Current shortest distance to get from the start node to this specific node
    g_score[start] = 0
    f_score = {node: float("inf") for row in grid for node in row}
    # Predicted distance from current node to the end
